...
# mv /var/www/app/views/pages/about.txt /var/www/app/views/pages/about.html.erb

sed -i .bkp "s/an_unknown_server/$(hostname)/" /var/www/app/views/pages/about.html.erb
